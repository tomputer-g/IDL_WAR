...
def main():
    ...
    parser.add_argument('--model', type=str, default='saved_models/encoder.pth')
    parser.add_argument('--image', type=str, default=None)
    parser.add_argument('--images_dir', type=str, default='/home/cmu/project/dataset/real')
    ...
    if args.save_dir is not None:
        ...
        with torch.no_grad():
            for filename in files_list:
                ...
                im.save(args.save_dir + '/' + save_name + '.png')
