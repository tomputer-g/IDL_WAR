...
class CustomImageFolder(Dataset):
    def __init__(self, data_dir, transform=None, data_cnt=-1, y=0,
                 shuffle=False, return_fname=False, fname_format="*",
                 save_img=False, step=0):
        ...
        self.step = step
        self.save_dir = f'./regen_image/{self.step}'
    ...
    def __getitem__(self, idx):
        ...
        if self.save_img:
            save_image(image, os.path.join(self.save_dir, os.path.basename(filename)))
