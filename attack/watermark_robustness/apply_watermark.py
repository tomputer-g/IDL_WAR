...
def main():
    ...
    parser.add_argument("--data_dir", default="images/imagenet/org", type=str)
    parser.add_argument("--data_cnt", default=-1, type=int)
    parser.add_argument("--out_dir", default="images/imagenet/dwtDct", type=str)
    ...
    if args.dataset == 'imagenet' or args.dataset == 'competition':
